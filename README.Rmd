...
[![appveyor](https://ci.appveyor.com/api/projects/status/github/btmonier/vidger?branch=master&svg=true)](https://ci.appveyor.com/project/btmonier/vidger)
...
[Bioconductor](http://bioconductor.org/). You can install it by:
